 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function el(n,e){if(n.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const t={alg:"none",type:"JWT"},i=e||"demo-project",s=n.iat||0,a=n.sub||n.user_id;if(!a)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const l={iss:`https://securetoken.google.com/${i}`,aud:i,iat:s,exp:s+3600,auth_time:s,sub:a,user_id:a,firebase:{sign_in_provider:"custom",identities:{}},...n};return[Vn(JSON.stringify(t)),Vn(JSON.stringify(l)),""].join(".")}const Wt={};function tl(){const n={prod:[],emulator:[]};for(const e of Object.keys(Wt))Wt[e]?n.emulator.push(e):n.prod.push(e);return n}function nl(n){let e=document.getElementById(n),t=!1;return e||(e=document.createElement("div"),e.setAttribute("id",n),t=!0),{created:t,element:e}}let Ms=!1;function ui(n,e){if(typeof window>"u"||typeof document>"u"||!ct(window.location.host)||Wt[n]===e||Wt[n]||Ms)return;Wt[n]=e;function t(b){return`__firebase__banner__${b}`}const i="__firebase__banner",a=tl().prod.length>0;function l(){const b=document.getElementById(i);b&&b.remove()}function u(b){b.style.display="flex",b.style.background="#7faaf0",b.style.position="fixed",b.style.bottom="5px",b.style.left="5px",b.style.padding=".5em",b.style.borderRadius="5px",b.style.alignItems="center"}function _(b,C){b.setAttribute("width","24"),b.setAttribute("id",C),b.setAttribute("height","24"),b.setAttribute("viewBox","0 0 24 24"),b.setAttribute("fill","none"),b.style.marginLeft="-6px"}function g(){const b=document.createElement("span");return b.style.cursor="pointer",b.style.marginLeft="16px",b.style.fontSize="24px",b.innerHTML=" &times;",b.onclick=()=>{Ms=!0,l()},b}function S(b,C){b.setAttribute("id",C),b.innerText="Learn more",b.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",b.setAttribute("target","__blank"),b.style.paddingLeft="5px",b.style.textDecoration="underline"}function E(){const b=nl(i),C=t("text"),P=document.getElementById(C)||document.createElement("span"),L=t("learnmore"),N=document.getElementById(L)||document.createElement("a"),O=t("preprendIcon"),D=document.getElementById(O)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(b.created){const B=b.element;u(B),S(N,L);const J=g();_(D,O),B.append(D,P,N,J),document.body.appendChild(B)}a?(P.innerText="Preview backend disconnected.",D.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bh(n){st(new ze("platform-logger",e=>new xl(e),"PRIVATE")),st(new ze("heartbeat",e=>new wh(e),"PRIVATE")),ye(qr,js,n),ye(qr,js,"esm2020"),ye("fire-js","")}bh("");var Sh="firebase",Ah="12.2.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ye(Sh,Ah,"app");function oa(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const kh=oa,aa=new en("auth","Firebase",oa());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lh=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Mh=new nn(3e4,6e4);function rn(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function bt(n,e,t,i,s={}){return la(n,s,async()=>{let a={},l={};i&&(e==="GET"?l=i:a={body:JSON.stringify(i)});const u=tn({key:n.config.apiKey,...l}).slice(1),_=await n._getAdditionalHeaders();_["Content-Type"]="application/json",n.languageCode&&(_["X-Firebase-Locale"]=n.languageCode);const g={method:e,headers:_,...a};return il()||(g.referrerPolicy="no-referrer"),n.emulatorConfig&&ct(n.emulatorConfig.host)&&(g.credentials="include"),ca.fetch()(await ha(n,n.config.apiHost,t,u),g)})}async function la(n,e,t){n._canInitEmulator=!1;const i={...Oh,...e};try{const s=new xh(n),a=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const l=await a.json();if("needConfirmation"in l)throw An(n,"account-exists-with-different-credential",l);if(a.ok&&!("errorMessage"in l))return l;{const u=a.ok?l.errorMessage:l.error.message,[_,g]=u.split(" : ");if(_==="FEDERATED_USER_ID_ALREADY_LINKED")throw An(n,"credential-already-in-use",l);if(_==="EMAIL_EXISTS")throw An(n,"email-already-in-use",l);if(_==="USER_DISABLED")throw An(n,"user-disabled",l);const S=i[_]||_.toLowerCase().replace(/[_\s]+/g,"-");if(g)throw gi(n,S,g);we(n,S)}}catch(s){if(s instanceof Ie)throw s;we(n,"network-request-failed",{message:String(s)})}}async function yi(n,e,t,i,s={}){const a=await bt(n,e,t,i,s);return"mfaPendingCredential"in a&&we(n,"multi-factor-auth-required",{_serverResponse:a}),a}async function ha(n,e,t,i){const s=`${e}${t}?${i}`,a=n,l=a.config.emulator?_i(n.config,s):`${n.config.apiScheme}://${s}`;return Lh.includes(t)&&(await a._persistenceManagerAvailable,a._getPersistenceType()==="COOKIE")?a._getPersistence()._getFinalTarget(l).toString():l}class xh{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,i)=>{this.timer=setTimeout(()=>i(fe(this.auth,"network-request-failed")),Mh.get())})}}function An(n,e,t){const i={appName:n.name};t.email&&(i.email=t.email),t.phoneNumber&&(i.phoneNumber=t.phoneNumber);const s=fe(n,e,i);return s.customData._tokenResponse=t,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Uh(n,e){return bt(n,"POST","/v1/accounts:delete",e)}async function Bn(n,e){return bt(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hn(n){const e=n.auth,t=await n.getIdToken(),i=await Qt(n,Bn(e,{idToken:t}));R(i?.users.length,e,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const a=s.providerUserInfo?.length?ua(s.providerUserInfo):[],l=Bh(n.providerData,a),u=n.isAnonymous,_=!(n.email&&s.passwordHash)&&!l?.length,g=u?_:!1,S={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:l,metadata:new Yr(s.createdAt,s.lastLoginAt),isAnonymous:g};Object.assign(n,S)}async function $h(n){const e=pe(n);await Hn(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Bh(n,e){return[...n.filter(i=>!e.some(s=>s.providerId===i.providerId)),...e]}function ua(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kh(n,e={}){return bt(n,"GET","/v2/passwordPolicy",rn(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nu(n,e){const t=tr(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),a=t.getOptions();if(it(a,e??{}))return s;we(s,"already-initialized")}return t.initialize({options:e})}function ru(n,e){const t=e?.persistence||[],i=(Array.isArray(t)?t:[t]).map(Re);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(i,e?.popupRedirectResolver)}function Ea(n,e,t){const i=St(n);R(/^https?:\/\//.test(e),i,"invalid-emulator-scheme");const s=!1,a=Ta(e),{host:l,port:u}=iu(e),_=u===null?"":`:${u}`,g={url:`${a}//${l}${_}/`},S=Object.freeze({host:l,port:u,protocol:a.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!i._canInitEmulator){R(i.config.emulator&&i.emulatorConfig,i,"emulator-config-failed"),R(it(g,i.config.emulator)&&it(S,i.emulatorConfig),i,"emulator-config-failed");return}i.config.emulator=g,i.emulatorConfig=S,i.settings.appVerificationDisabledForTesting=!0,ct(l)?(hi(`${a}//${l}${_}`),ui("Auth",!0)):su()}function Ta(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function iu(n){const e=Ta(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const i=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(i);if(s){const a=s[1];return{host:a,port:Ys(i.substr(a.length+1))}}else{const[a,l]=i.split(":");return{host:a,port:Ys(l)}}}function Ys(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function su(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ba{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return Pe("not implemented")}_getIdTokenResponse(e){return Pe("not implemented")}_linkToIdToken(e,t){return Pe("not implemented")}_getReauthenticationResolver(e){return Pe("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iu{constructor(e){this.target=e,this.handlers=new Set}removeMessageHandler(e){e.messageChannel&&(e.messageChannel.port1.removeEventListener("message",e.onMessage),e.messageChannel.port1.close()),this.handlers.delete(e)}async _send(e,t,i=50){const s=typeof MessageChannel<"u"?new MessageChannel:null;if(!s)throw new Error("connection_unavailable");let a,l;return new Promise((u,_)=>{const g=Ti("",20);s.port1.start();const S=setTimeout(()=>{_(new Error("unsupported_event"))},i);l={messageChannel:s,onMessage(E){const b=E;if(b.data.eventId===g)switch(b.data.status){case"ack":clearTimeout(S),a=setTimeout(()=>{_(new Error("timeout"))},3e3);break;case"done":clearTimeout(a),u(b.data.response);break;default:clearTimeout(S),clearTimeout(a),_(new Error("invalid_response"));break}}},this.handlers.add(l),s.port1.addEventListener("message",l.onMessage),this.target.postMessage({eventType:e,eventId:g,data:t},[s.port2])}).finally(()=>{l&&this.removeMessageHandler(l)})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Na(){return typeof ve().WorkerGlobalScope<"u"&&typeof ve().importScripts=="function"}async function Tu(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function bu(){return navigator?.serviceWorker?.controller||null}function Su(){return Na()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bi extends ba{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return mt(e,this._buildIdpRequest())}_linkToIdToken(e,t){return mt(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return mt(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function Du(n){return uu(n.auth,new bi(n),n.bypassAuthState)}function Ou(n){const{auth:e,user:t}=n;return R(t,e,"internal-error"),hu(t,new bi(n),n.bypassAuthState)}async function Lu(n){const{auth:e,user:t}=n;return R(t,e,"internal-error"),lu(t,new bi(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qu(n,e={}){return bt(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gd="__/auth/handler",md="emulator/auth/handler",_d=encodeURIComponent("fac");async function io(n,e,t,i,s,a){R(n.config.authDomain,n,"auth-domain-config-required"),R(n.config.apiKey,n,"invalid-api-key");const l={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:i,v:Tt,eventId:s};if(e instanceof Ei){e.setDefaultLanguage(n.languageCode),l.providerId=e.providerId||"",fl(e.getCustomParameters())||(l.customParameters=JSON.stringify(e.getCustomParameters()));for(const[S,E]of Object.entries({}))l[S]=E}if(e instanceof sn){const S=e.getScopes().filter(E=>E!=="");S.length>0&&(l.scopes=S.join(","))}n.tenantId&&(l.tid=n.tenantId);const u=l;for(const S of Object.keys(u))u[S]===void 0&&delete u[S];const _=await n._getAppCheckToken(),g=_?`#${_d}=${encodeURIComponent(_)}`:"";return`${yd(n)}?${tn(u).slice(1)}${g}`}function yd({config:n}){return n.emulator?_i(n,md):`https://${n.authDomain}/${gd}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eo="AsyncQueue";class To{constructor(e=Promise.resolve()){this.Xu=[],this.ec=!1,this.tc=[],this.nc=null,this.rc=!1,this.sc=!1,this.oc=[],this.M_=new Qd(this,"async_queue_retry"),this._c=()=>{const i=jr();i&&de(Eo,"Visibility state changed to "+i.visibilityState),this.M_.w_()},this.ac=e;const t=jr();t&&typeof t.addEventListener=="function"&&t.addEventListener("visibilitychange",this._c)}get isShuttingDown(){return this.ec}enqueueAndForget(e){this.enqueue(e)}enqueueAndForgetEvenWhileRestricted(e){this.uc(),this.cc(e)}enterRestrictedMode(e){if(!this.ec){this.ec=!0,this.sc=e||!1;const t=jr();t&&typeof t.removeEventListener=="function"&&t.removeEventListener("visibilitychange",this._c)}}enqueue(e){if(this.uc(),this.ec)return new Promise((()=>{}));const t=new qt;return this.cc((()=>this.ec&&this.sc?Promise.resolve():(e().then(t.resolve,t.reject),t.promise))).then((()=>t.promise))}enqueueRetryable(e){this.enqueueAndForget((()=>(this.Xu.push(e),this.lc())))}async lc(){if(this.Xu.length!==0){try{await this.Xu[0](),this.Xu.shift(),this.M_.reset()}catch(e){if(!Gd(e))throw e;de(Eo,"Operation failed with retryable error: "+e)}this.Xu.length>0&&this.M_.p_((()=>this.lc()))}}cc(e){const t=this.ac.then((()=>(this.rc=!0,e().catch((i=>{throw this.nc=i,this.rc=!1,Fa("INTERNAL UNHANDLED ERROR: ",bo(i)),i})).then((i=>(this.rc=!1,i))))));return this.ac=t,t}enqueueAfterDelay(e,t,i){this.uc(),this.oc.indexOf(e)>-1&&(t=0);const s=ki.createAndSchedule(this,e,t,i,(a=>this.hc(a)));return this.tc.push(s),s}uc(){this.nc&&Zt(47125,{Pc:bo(this.nc)})}verifyOperationInProgress(){}async Tc(){let e;do e=this.ac,await e;while(e!==this.ac)}Ic(e){for(const t of this.tc)if(t.timerId===e)return!0;return!1}Ec(e){return this.Tc().then((()=>{this.tc.sort(((t,i)=>t.targetTimeMs-i.targetTimeMs));for(const t of this.tc)if(t.skipDelay(),e!=="all"&&t.timerId===e)break;return this.Tc()}))}dc(e){this.oc.push(e)}hc(e){const t=this.tc.indexOf(e);this.tc.splice(t,1)}}function bo(n){let e=n.message||"";return n.stack&&(e=n.stack.includes(n.message)?n.stack:n.message+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ef="auth-internal",Tf="app-check-internal",bf="messaging-internal";function Sf(n){const e=(t,{instanceIdentifier:i})=>{const s=t.getProvider("app").getImmediate(),a=t.getProvider(Ef),l=t.getProvider(bf),u=t.getProvider(Tf);return new ff(s,a,l,u,i)};st(new ze(Ri,e,"PUBLIC").setMultipleInstances(!0)),ye(ko,Co,n),ye(ko,Co,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Af(n=pi(),e=ei){const i=tr(pe(n),Ri).getImmediate({identifier:e}),s=Qo("functions");return s&&Xa(i,...s),i}function Xa(n,e,t){pf(pe(n),e,t)}function ir(n,e,t){return gf(pe(n),e)}Sf();const Ni=typeof __firebase_config<"u";let yt,ti=null;Ni?(yt=JSON.parse(__firebase_config),ti=typeof __initial_auth_token<"u"?__initial_auth_token:null):yt={apiKey:"AIzaSyC3w_aZojKeEp3llhJlKlVGj_rbOHAMhb0",authDomain:"my-new-firebase-project-94e22.firebaseapp.com",projectId:"my-new-firebase-project-94e22",storageBucket:"my-new-firebase-project-94e22.firebasestorage.app",messagingSenderId:"210118924526",appId:"1:210118924526:web:c88671740e8b13e1e7fbff"};let Pn=null,vt=null,ni=null,Xn=null;yt&&yt.apiKey?(Pn=ra(yt),vt=kd(Pn),ni=tf(Pn),Xn=Af(Pn),Ni&&(async()=>{try{ti?(await fu(vt,ti),console.log("Firebase: Signed in with custom token.")):(await cu(vt),console.warn("Firebase: Signed in anonymously (no custom token)."))}catch(e){console.error("Firebase Authentication Failed:",e)}})()):console.error("Firebase initialization failed: Configuration (apiKey) is missing.");const Jt=vt,kf=new Ae,sr=Xn;if(location.hostname==="localhost"&&!Ni&&vt&&ni&&Xn){const n=yt.apiKey==="demo-api-key";Ha(ni,"localhost",8080),Xa(Xn,"localhost",5001),n&&Ea(vt,"http://localhost:9099")}var Yn,z,$r,Po,ri=0,Ya=[],q=$,Ro=q.__b,No=q.__r,Do=q.diffed,Oo=q.__c,Lo=q.unmount,Mo=q.__;function Qa(n,e){q.__h&&q.__h(z,n,ri||e),ri=0;var t=z.__H||(z.__H={__:[],__h:[]});return n>=t.__.length&&t.__.push({}),t.__[n]}function G(n){return ri=1,Cf(Za,n)}function Cf(n,e,t){var i=Qa(Yn++,2);if(i.t=n,!i.__c&&(i.__=[Za(void 0,e),function(u){var _=i.__N?i.__N[0]:i.__[0],g=i.t(_,u);_!==g&&(i.__N=[g,i.__[1]],i.__c.setState({}))}],i.__c=z,!z.__f)){var s=function(u,_,g){if(!i.__c.__H)return!0;var S=i.__c.__H.__.filter(function(b){return!!b.__c});if(S.every(function(b){return!b.__N}))return!a||a.call(this,u,_,g);var E=i.__c.props!==u;return S.forEach(function(b){if(b.__N){var C=b.__[0];b.__=b.__N,b.__N=void 0,C!==b.__[0]&&(E=!0)}}),a&&a.call(this,u,_,g)||E};z.__f=!0;var a=z.shouldComponentUpdate,l=z.componentWillUpdate;z.componentWillUpdate=function(u,_,g){if(this.__e){var S=a;a=void 0,s(u,_,g),a=S}l&&l.call(this,u,_,g)},z.shouldComponentUpdate=s}return i.__N||i.__}function At(n,e){var t=Qa(Yn++,3);!q.__s&&Nf(t.__H,e)&&(t.__=n,t.u=e,z.__H.__h.push(t))}function Pf(){for(var n;n=Ya.shift();)if(n.__P&&n.__H)try{n.__H.__h.forEach(Un),n.__H.__h.forEach(ii),n.__H.__h=[]}catch(e){n.__H.__h=[],q.__e(e,n.__v)}}q.__b=function(n){z=null,Ro&&Ro(n)},q.__=function(n,e){n&&e.__k&&e.__k.__m&&(n.__m=e.__k.__m),Mo&&Mo(n,e)},q.__r=function(n){No&&No(n),Yn=0;var e=(z=n.__c).__H;e&&($r===z?(e.__h=[],z.__h=[],e.__.forEach(function(t){t.__N&&(t.__=t.__N),t.u=t.__N=void 0})):(e.__h.forEach(Un),e.__h.forEach(ii),e.__h=[],Yn=0)),$r=z},q.diffed=function(n){Do&&Do(n);var e=n.__c;e&&e.__H&&(e.__H.__h.length&&(Ya.push(e)!==1&&Po===q.requestAnimationFrame||((Po=q.requestAnimationFrame)||Rf)(Pf)),e.__H.__.forEach(function(t){t.u&&(t.__H=t.u),t.u=void 0})),$r=z=null},q.__c=function(n,e){e.some(function(t){try{t.__h.forEach(Un),t.__h=t.__h.filter(function(i){return!i.__||ii(i)})}catch(i){e.some(function(s){s.__h&&(s.__h=[])}),e=[],q.__e(i,t.__v)}}),Oo&&Oo(n,e)},q.unmount=function(n){Lo&&Lo(n);var e,t=n.__c;t&&t.__H&&(t.__H.__.forEach(function(i){try{Un(i)}catch(s){e=s}}),t.__H=void 0,e&&q.__e(e,t.__v))};var xo=typeof requestAnimationFrame=="function";function Rf(n){var e,t=function(){clearTimeout(i),xo&&cancelAnimationFrame(e),setTimeout(n)},i=setTimeout(t,35);xo&&(e=requestAnimationFrame(t))}function Un(n){var e=z,t=n.__c;typeof t=="function"&&(n.__c=void 0,t()),z=e}function ii(n){var e=z;n.__c=n.__(),z=e}function Nf(n,e){return!n||n.length!==e.length||e.some(function(t,i){return t!==n[i]})}function Za(n,e){return typeof e=="function"?e(n):e}function Df(){const[n,e]=G(null),[t,i]=G(null);At(()=>{const l=Aa(Jt,e);return()=>l()},[]);async function s(){i(null);try{await xu(Jt,kf)}catch(l){if(console.error("Login failed:",l),l.code==="auth/unauthorized-domain"){const u=window.location.hostname==="0.0.0.0";i({type:"unauthorized-domain",message:"Login failed: Domain not authorized.",details:u?"Firebase does not allow OAuth on 0.0.0.0. Please use localhost.":`Add "${window.location.hostname}" to Authorized Domains in Firebase Console.`})}else i({message:l.message})}}async function a(){await mu(Jt)}return n?A("div",{class:"flex flex-col items-center justify-center h-screen space-y-4",children:[n.photoURL&&A("img",{src:n.photoURL,alt:"Profile",class:"rounded-full w-16 h-16"}),A("p",{class:"text-lg",children:["Hello, ",n.displayName||n.email,"!"]}),A("button",{onClick:a,class:"bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-800",children:"Sign Out"})]}):A("div",{class:"flex flex-col items-center justify-center h-screen space-y-4",children:[A("h2",{class:"text-2xl font-bold",children:"Welcome to Procrastinot"}),A("button",{onClick:s,class:"bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700",children:"Sign in with Google"}),t&&A("div",{class:"mt-4 p-4 bg-red-100 text-red-700 rounded max-w-md text-center border border-red-200",children:[A("p",{class:"font-bold",children:t.message}),A("p",{class:"text-sm mt-1",children:t.details||t.message}),t.type==="unauthorized-domain"&&window.location.hostname==="0.0.0.0"&&A("button",{onClick:()=>{const l=new URL(window.location.href);l.hostname="localhost",window.location.href=l.toString()},class:"mt-3 bg-red-600 text-white px-4 py-2 rounded text-sm hover:bg-red-700 shadow-sm",children:"Switch to localhost"})]})]})}const Of=ir(sr,"getRooms"),Lf=ir(sr,"createRoom"),Mf=ir(sr,"joinRoom"),xf=ir(sr,"startSession"),qe={getRooms:async()=>(await Of()).data,createRoom:async n=>(await Lf(n)).data,joinRoom:async n=>(await Mf({inviteCode:n})).data,startSession:async(n,e)=>(await xf({roomId:n,mode:e})).data,getFriends:async n=>(console.warn("MOCK: getFriends using placeholder data."),[{id:"f1",name:"Alex Focus",status:"in-session"},{id:"f2",name:"Ben Chill",status:"offline"}]),getFriendActivity:async n=>(console.warn("MOCK: getFriendActivity using placeholder data."),{completedSessions:5,nudgesReceived:2})};function Uf({onRoomCreated:n}){console.log("CreateRoom component rendering");const[e,t]=G("");async function i(s){if(s.preventDefault(),!!e.trim())try{const a=await qe.createRoom({name:e});typeof n=="function"&&n(a),t("")}catch(a){console.error("Failed to create room:",a.message)}}return A("form",{onSubmit:i,class:"flex items-center space-x-2",children:[A("input",{type:"text",value:e,onInput:s=>t(s.target.value),placeholder:"New room name",class:"border px-2 py-1 rounded"}),A("button",{type:"submit",class:"bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700",children:"Create"})]})}function Ff({onRoomJoined:n}){console.log("JoinRoom component rendering");const[e,t]=G("");async function i(s){if(s.preventDefault(),!!e.trim())try{const a=await qe.joinRoom(e);n(a),t("")}catch(a){console.error("Failed to join room:",a.message)}}return A("form",{onSubmit:i,class:"flex items-center space-x-2",children:[A("input",{type:"text",value:e,onInput:s=>t(s.target.value),placeholder:"Enter invite code",class:"border px-2 py-1 rounded"}),A("button",{type:"submit",class:"bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700",children:"Join"})]})}function Vf({roomId:n,onSessionStarted:e}){console.log("StartSession component rendering");const[t,i]=G("pomodoro");async function s(){try{const a=await qe.startSession(n,t);e(a)}catch(a){console.error("Failed to start session:",a.message)}}return A("div",{class:"flex items-center space-x-2",children:[A("select",{value:t,onChange:a=>i(a.target.value),class:"border px-2 py-1 rounded",children:[A("option",{value:"pomodoro",children:"Pomodoro (25 min)"}),A("option",{value:"short_break",children:"Short Break (5 min)"}),A("option",{value:"long_break",children:"Long Break (15 min)"})]}),A("button",{onClick:s,class:"bg-purple-600 text-white px-3 py-1 rounded hover:bg-purple-700",children:"Start Session"})]})}function jf({roomId:n,sessionId:e,userId:t}){const[i,s]=G(""),[a,l]=G(!1),[u,_]=G(null);async function g(S){if(S.preventDefault(),!!i.trim()){l(!0),_(null);try{await qe.trackProgress(n,e,t,{task:i}),s("")}catch(E){_(E.message)}finally{l(!1)}}}return A("form",{onSubmit:g,class:"mt-4",children:[A("h4",{class:"font-semibold mb-2",children:"Track Your Progress"}),A("div",{class:"flex items-center space-x-2",children:[A("input",{type:"text",value:i,onInput:S=>s(S.target.value),placeholder:"Enter a completed task",class:"border px-2 py-1 rounded w-full",disabled:a}),A("button",{type:"submit",class:"bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 disabled:bg-gray-400",disabled:a,children:a?"Submitting...":"Submit"})]}),u&&A("p",{class:"text-red-500 mt-2",children:["Error: ",u]})]})}function $f({room:n,user:e}){return n?A("div",{class:"p-4 border rounded-lg shadow-sm",children:[A("h3",{class:"text-xl font-bold mb-2",children:n.name}),A("p",{children:[A("strong",{children:"Mode:"})," ",n.mode]}),A("p",{children:[A("strong",{children:"Invite Code:"})," ",A("span",{class:"font-mono bg-gray-200 p-1 rounded",children:n.inviteCode})]}),A(jf,{roomId:n.id,sessionId:"s_placeholder_123",userId:e.uid})]}):A("div",{children:"Select a room to see details."})}function Bf({user:n}){const[e,t]=G([]),[i,s]=G(null),a=()=>{qe.getRooms().then(g=>{Array.isArray(g)?t(g):console.error("API did not return an array for rooms:",g)}).catch(console.error)};At(()=>{a()},[]);const l=g=>{const S=e.findIndex(E=>E.id===g.id);if(S>-1){const E=[...e];E[S]=g,t(E)}else t([...e,g])},u=g=>{console.log("Session started:",g),alert(`Session started with mode: ${g.mode}`)},_=e.find(g=>g.id===i);return A("div",{class:"container mx-auto p-4",children:[A("div",{class:"flex space-x-4 mb-6",children:[A(Uf,{onRoomCreated:l}),A(Ff,{onRoomJoined:l})]}),A("div",{class:"grid grid-cols-1 md:grid-cols-2 gap-8",children:[A("div",{children:[A("h3",{class:"text-xl font-semibold mb-3",children:"My Rooms"}),A("ul",{class:"space-y-3",children:e.map(g=>A("li",{class:`p-4 border rounded-lg flex justify-between items-center shadow-sm cursor-pointer hover:bg-gray-100 ${i===g.id?"bg-gray-200":""}`,onClick:()=>s(g.id),children:[A("span",{class:"font-medium",children:g.name}),A(Vf,{roomId:g.id,onSessionStarted:u})]},g.id))})]}),A("div",{children:[A("h3",{class:"text-xl font-semibold mb-3",children:"Room Details"}),A($f,{room:_,user:n})]})]})]})}function Hf({activePage:n,setActivePage:e}){return A("nav",{class:"bg-gray-800 text-white p-4",children:A("ul",{class:"flex space-x-4",children:["Rooms","Friends","Accountability"].map(i=>A("li",{children:A("a",{href:"#",class:`hover:text-gray-300 ${n===i.toLowerCase()?"font-bold":""}`,onClick:s=>{s.preventDefault(),e(i.toLowerCase())},children:i})},i))})})}function Wf({user:n}){const[e,t]=G([]),[i,s]=G(!0),[a,l]=G(null);return At(()=>{if(console.log("FriendsPage user:",n),!!n){s(!0);try{qe.getFriends(n.uid).then(u=>{Array.isArray(u)?t(u):t([]),l(null)}).catch(u=>{l(u.message),t([])}).finally(()=>s(!1))}catch(u){l(u.message),s(!1)}}},[n]),A("div",{class:"p-4",children:[A("h2",{class:"text-2xl font-bold mb-4",children:"Focus Friends"}),i&&A("div",{children:"Loading friends..."}),a&&A("div",{class:"text-red-500",children:["Error: ",a]}),!i&&!a&&A("ul",{class:"space-y-3",children:e.map(u=>A("li",{class:"p-4 border rounded-lg flex justify-between items-center shadow-sm",children:[A("span",{class:"font-medium",children:u.name}),A("span",{class:`px-2 py-1 text-sm rounded-full ${u.status==="in-session"?"bg-green-200 text-green-800":"bg-gray-200 text-gray-800"}`,children:u.status})]},u.id))})]})}function zf({friend:n}){const[e,t]=G(null),[i,s]=G(!0);return At(()=>{qe.getFriendActivity(n.id).then(a=>{t(a),s(!1)})},[n.id]),A("li",{class:"p-4 border rounded-lg shadow-sm",children:[A("h3",{class:"font-bold",children:n.name}),i?A("p",{children:"Loading progress..."}):A("div",{class:"mt-2",children:[A("p",{children:["Completed Sessions: ",e.completedSessions]}),A("p",{children:["Nudges Received: ",e.nudgesReceived]}),A("button",{class:"mt-2 bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600",children:"Nudge"})]})]})}function Gf({user:n}){const[e,t]=G([]),[i,s]=G(!0),[a,l]=G(null);return At(()=>{n&&(s(!0),qe.getFriends(n.uid).then(u=>{Array.isArray(u)?t(u):t([]),l(null)}).catch(u=>{l(u.message),t([])}).finally(()=>s(!1)))},[n]),A("div",{class:"p-4",children:[A("h2",{class:"text-2xl font-bold mb-4",children:"Peer Progress"}),i&&A("div",{children:"Loading friends..."}),a&&A("div",{class:"text-red-500",children:["Error: ",a]}),!i&&!a&&A("ul",{class:"space-y-4",children:e.map(u=>A(zf,{friend:u},u.id))})]})}function qf(){const[n,e]=G(null),[t,i]=G(!0),[s,a]=G("rooms");return At(()=>{if(!Jt)return console.error("Firebase Auth instance is null. Skipping authentication listeners."),i(!1),()=>{};const l=Aa(Jt,u=>{e(u),i(!1)});return()=>l()},[]),t?A("div",{children:"Loading..."}):A("main",{children:n?A("div",{children:[A(Hf,{activePage:s,setActivePage:a}),s==="rooms"&&A(Bf,{user:n}),s==="friends"&&A(Wf,{user:n}),s==="accountability"&&A(Gf,{user:n})]}):A(Df,{})})}Hc(A(qf,{}),document.getElementById("app"));
